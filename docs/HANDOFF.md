...
## 現在地（最終更新: 2026-06-03）
- **App Store 再提出済み（v1.0.0）。2回目の審査結果待ち。** 初回リジェクト(Guideline 4 権限言語 / 3.1.2c サブスク情報)に対応:写真権限の英語デフォルト+ja化、ペイウォールに機能するEULA/プライバシーリンク+自動更新説明、利用規約HTML公開(docs/terms.html)、ASC説明文にリンク追記、onboarding固定幅解消(iPad)。
